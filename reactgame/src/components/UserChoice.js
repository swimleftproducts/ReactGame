    ...
    render(){
        return (
            <div onClick={()=>{
                ...
                this.props.setUserPage(this.props.userChoice.type)}} className={`${this.props.userPage===this.props.userChoice.type?"selected-card-active":""} card selected-card col-xl-6 col-lg-3 col-sm-3`}>
