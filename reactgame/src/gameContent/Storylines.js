const gameSetUp = {
    ...
    stories: [{
            ...
            HintsWeapon: "Capow, not bang",
            HintsWeapon1: "According to the GPD, they found a mysterious and a piece of dark cloth that along the side of the road. The GPD also said that the cloth was made of a very high quality material.",
            HintsLocation: "worse than new york",
            HintsLocation1: "There is a rumor that 3 blocks from the crime scene, there is a person who might know the killer. Rumor also said that the person can be found in the 11th floor of the tallest building in the city.",
            HintsName: "wayne enterprises CEO",
            HintsName1: "There was a fallen card right next to the garbage. It was wet and was not readable but it seems there is a logo on the right top corner of card.",
            game: 0,
            cheat: () => {
        ...
        },
        {
            ...
            HintsLocation1: "There is a rummor that the town where the killings took place is a main town in the shire .",
            HintsLocation2: "Sam Gamgee was particularlly attentive to healing this area with soil from Galadriel",
